    ...
    <>
      <div className="flex items-center gap-3">
        <button 
          ...
          className="h-14 px-6 bg-white/5 border border-white/10 rounded-2xl flex items-center gap-3 text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all active:scale-95 group"
        >
        ...
        <button 
          ...
          className={`h-14 px-8 ${style.bg} rounded-2xl flex items-center gap-3 text-[10px] font-black uppercase tracking-widest hover:brightness-110 transition-all active:scale-95 shadow-2xl ${style.glow?.replace('blur', '')}`}
        >
